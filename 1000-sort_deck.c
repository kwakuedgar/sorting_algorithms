...
/**
 * sort_suit - sorts a deck of cards by suit
 * @deck: deck to sort
 */
void sort_suit(deck_node_t **deck)
{
...
/**
 * sort_val - sorts a deck of cards staticly by value
 * @deck: deck to sort
 */
void sort_val(deck_node_t **deck)
{
...
/**
 * swap - swaps 2 consecutive cards of a doubly linked lists
 * @deck: Head node for deck
 * @card1: first card to swap
 * @card2: second card to swap
 */
void swap(deck_node_t **deck, deck_node_t *card1, deck_node_t *card2)
{
...
/**
 * vcmp - compares the value of 2 cards
